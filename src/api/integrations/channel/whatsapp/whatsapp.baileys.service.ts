  ...
  private async createClient(number?: string): Promise<WASocket> {
    ...
    const socketConfig: UserFacingSocketConfig = {
      ...
      patchMessageBeforeSending(message) {
        ...
        if (
          message.deviceSentMessage?.message?.buttonsMessage?.headerType === proto.Message.ButtonsMessage.HeaderType.TEXT
        ) {
          message = JSON.parse(JSON.stringify(message));

          message.deviceSentMessage.message.buttonsMessage.headerType = proto.Message.ButtonsMessage.HeaderType.EMPTY;
        }

        if (message.buttonsMessage?.headerType == proto.Message.ButtonsMessage.HeaderType.TEXT) {
          message = JSON.parse(JSON.stringify(message));

          message.buttonsMessage.headerType = proto.Message.ButtonsMessage.HeaderType.EMPTY;
        }
